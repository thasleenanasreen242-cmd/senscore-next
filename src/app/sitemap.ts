...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    "/industries",
    "/knowledge-centre",
    "/knowledge-centre/flow-measurement",
    "/knowledge-centre/level-measurement",
    "/knowledge-centre/pressure-temperature",
    "/knowledge-centre/process-analysis",
    "/knowledge-centre/automation-connectivity",
