...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "SensCore | Industrial Instrumentation, Automation & Engineering Solutions UAE",
    description: "Industrial instrumentation, automation, flow control and engineered solutions for real operating environments across the UAE.",
    url: "https://www.senscoretech.com/",
    siteName: "SensCore",
    locale: "en_US",
    type: "website",
    images: [{ url: "/logo.png.webp", alt: "SensCore" }],
  },
  twitter: {
  ...
  "@graph": [
    {
      ...
      address: { "@type": "PostalAddress", streetAddress: "9th Floor, Mazyad Mall, Business Tower 3, MBZ City", addressLocality: "Abu Dhabi", addressCountry: "AE" },
      sameAs: ["https://www.linkedin.com/company/senscore/", "https://www.instagram.com/senscoretech"],
    },
    {
      "@type": "WebSite",
      ...
      url: "https://www.senscoretech.com",
      name: "SensCore",
      publisher: { "@id": "https://www.senscoretech.com/#organization" },
    },
  ],
};
